 ...
 * @author Agam
 */
public class Agam07220_UpdatePasien extends javax.swing.JFrame {
    ...
    JTextField usertext, passtext, passbarutext;
    JButton back, updt;
    private static Scanner input = new Scanner(System.in);

    public Agam07220_UpdatePasien() {
        ...
        passlabel = new JLabel("password Lama");
        ...
        passbarulabel.setBounds(200, 380, 100, 30);
        Dokter.add(passbarulabel);

        passbarutext = new JTextField();
        passbarutext.setBounds(200, 410, 100, 30);
        Dokter.add(passbarutext);

        updt = new JButton("Ganti Password");
        updt.setBounds(350, 350, 200, 30);
    ...
    public void btnConfirmDialogActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String newpass = passbarutext.getText();
        ...
        switch (jawab) {
            case JOptionPane.YES_OPTION:
                try {
                    ...
                    Agam07220_AllObjCtrl.Pasien.setPasienEntity(index).setPassword(newpass);
                    JOptionPane.showMessageDialog(null, "Ganti Password Sukses", "information", JOptionPane.INFORMATION_MESSAGE);
                    kosong();
